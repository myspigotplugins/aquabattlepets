package io.github.shiryu.aquabattlepets.nms.v1_8_R1;

import io.github.shiryu.aquabattlepets.api.util.ReflectionUtil;
import io.github.shiryu.aquabattlepets.nms.v1_8_R1.pets.PetBat;
import io.github.shiryu.aquabattlepets.nms.v1_8_R1.pets.PetWither;
...
public enum EntityTypes {
    ...
    private void init(@NotNull final String name, final int id, @NotNull final Class<? extends Entity> clazz){
        final Class<?> entityTypesClass = net.minecraft.server.v1_8_R1.EntityTypes.class;
